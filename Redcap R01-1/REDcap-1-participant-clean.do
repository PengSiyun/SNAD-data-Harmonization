...
cd "C:\Users\siyunpeng\Dropbox\peng\Academia\Work with Brea\SNAD\SNAD data\codes\Redcap R01-1" //home
do "REDcap-R01-Participant-import" //import excel from Redcap into stata
cd "C:\Users\siyunpeng\Dropbox\peng\Academia\Work with Brea\SNAD\SNAD data\codes\Redcap R01-1\temp" //home
save "REDcap-1-participant-raw",replace
...
append using "C:\Users\siyunpeng\Dropbox\peng\Academia\Work with Brea\SNAD\SNAD data\codes\Redcap R01-old\Cleaned\REDcap-old-R01-participant-demographics.dta"
append using "C:\Users\siyunpeng\Dropbox\peng\Academia\Work with Brea\SNAD\SNAD data\codes\Pilot missing demo clean\pilot-participant-missingdemo"
...
save "C:\Users\siyunpeng\Dropbox\peng\Academia\Work with Brea\SNAD\SNAD data\codes\Redcap R01-1\Cleaned\REDcap-1-participant-demographics.dta",replace
...
replace patient_old="1" if patient_old=="under 1"
replace patient_old="" if patient_old=="sister"
destring patient_old,replace
replace living_number="" if living_number=="not applicable"
destring living_number,replace

append using "C:\Users\siyunpeng\Dropbox\peng\Academia\Work with Brea\SNAD\SNAD data\codes\Redcap R01-old\Cleaned\REDcap-old-R01-participant.dta"
...
*different naming in old and new r01
replace volunteer=volunteering if missing(volunteer) 
drop volunteering
replace integration1=belong_community1 if integration1==.
replace integration2=close_community1 if integration2==.
replace integration3=comfort_community1 if integration3==.
drop belong_community1 close_community1 comfort_community1

save "C:\Users\siyunpeng\Dropbox\peng\Academia\Work with Brea\SNAD\SNAD data\codes\Redcap R01-1\Cleaned\REDcap-1-participant.dta",replace
