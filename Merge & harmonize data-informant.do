...
***************************************************************
**# 2a Append Pilot+ENSO+NC INFORMANT report of FOCAL (pilot match)
***************************************************************
...
***************************************************************
**# 2b Append ENSO+NC data (ENSO added anyone else + study partner generators on top of pilot important/health matters) (ENSO matched)
***************************************************************
...
***************************************************************
**# 2c Append full participant ENSO+NC (R01raw)
***************************************************************
...
***************************************************************
**# 2d Append NC matched data (workdays and weekends generators are dropped at early of 2021) (NCmatch)
***************************************************************
...
save "SNAD-MatchData-informant focal.dta", replace //match all SNAD ego regardless of they have important/health matter
...
merge m:1 SUBID using "SNAD-MatchData-informant focal.dta"
...
save "red-Clean-snadMatch-informant focal.dta",replace
...
*load Redcap data
use "red-Clean-snadMatch-informant focal.dta", clear 
