...
************************************************************
**# 4a. clean the variable names across 5 ENSO waves (Full/Raw)
************************************************************
...
************************************************************
**# 4b. clean the variable names across 5 ENSO waves (R01match)
************************************************************


restore

*R01 match (NC dropped weekdays & weekend ties)
egen match=rowtotal(simp* shlth* scaregiv* sfamily* scowrkrs* sneighbrs* sanyelse* spartner*),mi
drop if match==0 | missing(match) //drop names that are weekdays & weekend ties
...
gen ENSO=1
save "ENSO-Informant-Informant alter-LONG-R01match-clean.dta", replace 
duplicates drop SUBID, force
keep SUBID created_on netsize-ENSO
drop tfem tkin tclose tfreq thassles numsup white alter_race alter_age numsup numsup3 prox30 tlkcare hlthprob alterprox alterdtr alterquestion ssupcare ssupcash ssupchor ssuplstn ssupsugg shassle stlkcare shlthprob ttrust //drop alter level variables
save "ENSO-Informant-Informant alter-EGOAGG-R01match-clean.dta", replace 
